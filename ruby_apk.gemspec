...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rspec-collection_matchers>, [">= 1.1.0"])
      s.add_development_dependency(%q<rspec-mocks>, [">= 3.6.0"])
      ...
      s.add_dependency(%q<rspec-collection_matchers>, [">= 1.1.0"])
